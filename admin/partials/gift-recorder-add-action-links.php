...
function gift_recorder_add_settings_link_filter( $links ) { 
 ...
 $links[] = '<a href="https://paypal.me/Wonkasoft" target="_blank"><img src="' . plugin_dir_url( "gift-recorder" ) . "gift-recorder/admin/img/gift-recorder-logo-2.svg" . '" style="width: 30px; height: 20px; display: inline-block;
...
function gift_recorder_add_description_link_filter( $links, $file ) {
  if ( strpos($file, 'gift-recorder.php') !== false ) {
    ...
    $links[] = '<a href="https://paypal.me/Wonkasoft" target="_blank">Donate <img src="' . plugin_dir_url( "gift-recorder" ) . "gift-recorder/admin/img/gift-recorder-logo-2.svg" . '" style="width: 30px; height: 20px; display: inline-block;
